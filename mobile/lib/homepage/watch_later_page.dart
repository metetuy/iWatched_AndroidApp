...
import 'package:iwatched/utilities/filter_dialog_util.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        floatingActionButton: FloatingActionButton(
          ...
          onPressed: () => FilterDialogUtil.showFilterDialog(
            context: context,
            availableGenres: controller.getAvailableGenres(),
            onApply: (sortBy, ascending, genre) {
              controller.applyFilter(sortBy, ascending, genre);
            },
          ),
        ...
        body: Obx(() {
          ...
          return ListView.builder(
            itemCount: controller.filteredWatchLaterMovies.length,
            itemBuilder: (context, index) {
              final movie = controller.filteredWatchLaterMovies[index];
